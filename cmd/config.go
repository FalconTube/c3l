...
func writeConfigToFile(filename string) error {
	...
	defaultPrompts := utils.ExpandPrompts{Entries: map[string]string{"example": "Using the '--expand' flag with the word 'example' as the prompt will expand into this string."}}
